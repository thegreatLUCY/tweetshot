...
(function () {
  ...
  const REPO_URL = window.TXE_REPO_URL || 'https://github.com/thegreatLUCY/tweetshot';
  ...
  const SPRITE = `<svg class="txe-sprite" aria-hidden="true" focusable="false"><defs>
    ...
    <symbol id="txe-i-star" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"><path d="M12 3.7l2.55 5.17 5.7.83-4.13 4.02.98 5.68L12 16.72l-5.1 2.68.98-5.68L3.75 9.7l5.7-.83L12 3.7Z"/></symbol>
        ...
        <div class="txe-foot">
          ...
          <div class="txe-footmain">
            ...
            <div class="txe-footbtns">
              <a class="txe-star" id="txeStar" href="${REPO_URL}" target="_blank" rel="noopener noreferrer"
                 title="${t('star_title', 'TweetShot is open source and runs entirely on your device. A star helps.')}">
                ${ic('star')}<span>${t('star_cta', 'Star on GitHub')}</span>
              </a>
