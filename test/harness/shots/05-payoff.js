async page => {
  ...
  await page.mouse.move(at(0.56, 0.44)[0], at(0.56, 0.44)[1], { steps: 6 });
  await page.mouse.move(at(0.46, 0.54)[0], at(0.46, 0.54)[1], { steps: 6 });
  await page.mouse.up();
  await page.waitForTimeout(300);
  await page.evaluate(() => { const el = document.querySelector('#txeSize'); el.value = 150; el.dispatchEvent(new Event('input', { bubbles: true })); });
  await page.mouse.move(at(0.19, 0.86)[0], at(0.19, 0.86)[1]);
  await page.mouse.down();
  await page.mouse.move(at(0.25, 0.9)[0], at(0.25, 0.9)[1], { steps: 5 });
  await page.mouse.up();
